# Script: cos_upload_large.py
# Purpose: upload a file to IBM Cloud Object Storge
#
# Note: 
#  set up venv for using in laptop
#   C:\Users\xxxxx\Denis_files\python_proj\practise\venv311\Scripts\activate.bat
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print( """
        This script uploads a file to object storage.
        - item_name: name  object storge
        - file_path: local file name with full path

        Usage: python""" + sys.argv[0] + " item_name file_path "
        )
        sys.exit(0)
    ...
    multi_part_upload(MY_BUCKET_NAME, item_name, file_path)
