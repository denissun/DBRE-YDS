#!/bin/bash
#
# Script: drop_user_180day_inactive.sh
# Usage:  drop_user_180day_inactive.sh 
#
...
TS=`date +%Y%m%d%H%M`
OUTFILE=drop_user_180day_inactive_${TS}.log
...
TMPOUTFILE=drop_user_180day_inactive_tmp.out
...
$SQLPLUSCOMMAND <<EOF
spool drop_user_180day_inactive_${INSTANCE_NAME}_$pdbname_${HOSTNAME}_$TS.spool
alter session set container=$pdbname;
show con_name;
@drop_user_180day_inactive.sql
spool off
exit;
EOF
...
$SQLPLUSCOMMAND <<EOS
spool drop_user_180day_inactive_${INSTANCE_NAME}_${HOSTNAME}_$TS.spool
